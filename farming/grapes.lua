...
minetest.register_craftitem("farming:grapes", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if nodename == "farming:trellis" then
			minetest.set_node(pointed_thing.under, {name = "farming:grapes_1", param2=mcore.options("croplike", false, false, false)})
...
minetest.register_node("farming:trellis", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		minetest.set_node(pointed_thing.above, {name = "farming:trellis", param2 = mcore.options("croplike", false, false, false) } )
